...
class CryptAPI extends \Opencart\System\Engine\Controller
{
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            //$_POST['payment_blockbee_cryptocurrencies'] = $a;
        ...
        //var_dump($data['payment_blockbee_cryptocurrencies']);
        //var_dump($this->request->post['payment_blockbee_cryptocurrencies']);
        //var_dump($supported_coins);
        // foreach ($supported_coins as $ticker => $coin) {
        //     if (isset($this->request->post['payment_blockbee_cryptocurrencies_address_' . $ticker])) {
        //         $data['payment_blockbee_cryptocurrencies_address_' . $ticker] = $this->request->post['payment_blockbee_cryptocurrencies_address_' . $ticker];
        //     } else {
        //         $data['payment_blockbee_cryptocurrencies_address_' . $ticker] = $this->config->get('payment_blockbee_cryptocurrencies_address_' . $ticker);
        //     }
        // }
